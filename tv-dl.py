...
def scrape(source):
	...
	for idx in epi_idx:		
		...
		#~ e_link_gorilla_s=source.find('http://www.free-tv-video-online.me/player/gorillavid.php?id=',st,end)+len('http://www.free-tv-video-online.me/player/gorillavid.php?id=')
		#~ e_link_gorilla_e=e_link_gorilla_s+12
		#~ if source.find('http://www.free-tv-video-online.me/player/gorillavid.php?id=',st,end)>0:			
